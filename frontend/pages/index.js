  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Droi Exchange!</h1>
          <div className={styles.description}>
            Exchange Ethereum &#60;&#62; Droi Tokens
          </div>
          <div>
            <button
      ...
      <footer className={styles.footer}>
        Made with &#10084; by LearnDao & <a href="https://droigon.com" target="blank"> Droigon</a>
      </footer>
    </div>
  );
}